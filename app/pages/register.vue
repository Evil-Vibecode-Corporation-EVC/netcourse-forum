  ...
  <main class="min-h-screen bg-slate-950 flex items-center justify-center px-4 pt-16">
    ...
    <div
      ...
      <form @submit.prevent="handleRegister" class="space-y-4">
        ...
        <div
          v-if="successMsg"
          class="px-4 py-3 bg-emerald-500/10 border border-emerald-500/30 rounded-xl text-emerald-400 font-mono text-sm"
        >
          ✓ {{ successMsg }}
        </div>
        ...
        >
          ...
          <span>
            {{ loading ? $t('auth.registerLoading') : '$ create_account.sh' }}
          </span>
        </button>
      </form>
